...
%% almost as usual
\author{Reinhard Simon\\International Potato Center (CIP) \And 
        David M. Spooner\\University of Madison}
\title{Tools for Taxonomists: data conversion and checks in package \pkg{mcpd}}
